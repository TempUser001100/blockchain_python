...
def main():
    ...
    parser.add_argument('--n_generator', type=int, default=12)
    parser.add_argument('--n_rank_calculator', type=int, default=12)
...
if __name__ == '__main__':
    main()
    # data_path,embedding_dim,max_epoch,batch_size,learning_rate
